...
////funcao de espalhamento quadratico
int f_espalhmamentoquadratico(tabela *Hash,int chave,int tamhash);
////funcao de espalhamento duplo
int f_espalhamentoduplo(tabela *Hash,int chave, int tamhash);
//// funcao de re espalhamneto da tabela
