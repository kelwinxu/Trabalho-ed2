...
tabela *f_carregatabela(char path[100]);                            //// carrega a tabela na memoria
tabela *f_ineserenatabela(char str[100]);                           ////insere na tabela hash que esta na memmoria
void f_inserehashnorquivo(tabela *Hash,char path[100]);             ////insere tabela hash no arquivo txt
int f_chave(char nusp[MAX_SIZE],int mod);                           //// funcao hash
void f_buscahash(tabela *Hash,char input[MAX_SIZE]);                //// busca na tabela hash
void f_removehash(tabela *Hash,char input[MAX_SIZE]);               ////remove um elemento da tabela
void menu(tabela *Hash, FILE *arq, char str[100]);                  //// menu
